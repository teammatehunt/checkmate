...
ORIGIN = f"https://{CHECKMATE_HOSTNAME}"
# Assume only localhost uses a non-standard HTTPS port.
if CHECKMATE_HOSTNAME == "localhost":
    ORIGIN += f":{CHECKMATE_BIND_PORT_HTTPS}"
